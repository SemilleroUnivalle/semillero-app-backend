...
class OfertaAcademicaViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(
        operation_summary="Listar todos los Categoria",
    ...
    @swagger_auto_schema(
        operation_summary="Crear un Categoria",
        operation_description="Crea un nuevo registro de Categoria",
        responses={
            status.HTTP_201_CREATED: CategoriaSerializer,
    ...
    @swagger_auto_schema(
        operation_summary="Obtener una Categoria específico",
        operation_description="Retorna los detalles de una Categoria, específico por su ID"
    )
    def retrieve(self, request, *args, **kwargs):
        return super().retrieve(request, *args, **kwargs)
    
    @swagger_auto_schema(
        operation_summary="Actualizar una Categoria",        
        operation_description="Actualiza todos los campos de una Categoria, existente"
    )
    def update(self, request, *args, **kwargs):
        data = request.data
        print(f"Actualizandna Categoria, con ID {kwargs['pk']} y datos: {data}")
        ...
        #Responder con los datos dena Categoria", actualizado
        return Response(serializer.data)

    @swagger_auto_schema(
        operation_summary="Actualizar parcialmente una Categoria",
        operation_description="Actualiza uno o más campos de una Categoria, existente"
    )
    ...
    @swagger_auto_schema(
        operation_summary="Eliminar una Categoria",
        operation_description="Elimina permanentemente una Categoria, del sistema"
    )
